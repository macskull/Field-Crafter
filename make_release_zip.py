...
def build_zip(source_dir: Path, output_zip: Path) -> None:
    ...
    required = {
        ...
        f"{prefix}src/hc_recipe_db/memory_structural_diagnostics.py",
        f"{prefix}src/hc_recipe_db/memory_structural_recovery.py",
        f"{prefix}src/hc_recipe_db/memory_recovery.py",
        f"{prefix}src/hc_recipe_db/memory_root_recovery.py",
