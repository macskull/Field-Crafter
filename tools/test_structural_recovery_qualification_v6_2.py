...
def _extract_sample_metrics(
    ...
    for kind, block, prefix in (
        ...
        header_clear = bool(
            block.get("header_anchor_type_aware")
            and header.get("type_aware_clear_winner")
        )
        metrics[f"{prefix}_header"] = {
            ...
            "expected_score": header.get("type_aware_score"),
            "best_score": header.get("type_aware_score"),
            "runner_up_score": None,
            "margin_vs_runner_up": header.get("type_aware_score_margin"),
            "best_candidate_key": (
...
def main() -> int:
    ...
    try:
        ...
        result = {
            ...
            "type_aware_entry_anchor_expected": True,
            "type_aware_entry_anchor_strong_in_inventory_drift_scenarios": all(
