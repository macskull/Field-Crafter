...
binaries = []
hiddenimports = [
    "hc_recipe_db.memory_profiles",
    "hc_recipe_db.memory_profile_updates",
    "hc_recipe_db.memory_update_crypto",
    "hc_recipe_db.application_updates",
    "hc_recipe_db.application_update_helper",
    "hc_recipe_db.memory_diagnostics",
    "hc_recipe_db.memory_recovery",
    "hc_recipe_db.memory_root_recovery",
    "hc_recipe_db.memory_structural_diagnostics",
